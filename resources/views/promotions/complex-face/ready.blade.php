    ...
    <section class="catalog-section">
        ...
        <div class="catalog-section__head"
            ...
            <div class="container-xxl h-100 d-flex flex-column justify-content-end justify-content-lg-between">
                <div class="head-breadcrumbs d-none d-lg-flex flex-wrap">
                    ...
                    <span>/</span>
                    <a href="/promotions/complex-face/">Лицо</a>
                </div>
        ...
        <div class="container-xxl">
                ...
                <div class="catalog-section__menu w-100">
                    <div class="catalog-section__menu__slides swiper">
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide">
                                <a href="/promotions/complex-face/ready/" class="d-block catalog-section__menu__item catalog-section__menu__item_active">Готовые наборы</a>
                            </div>
                                                            <div class="swiper-slide">
                                    <a href="/promotions/complex-face/" class="d-block catalog-section__menu__item">Собери себе уход</a>
                                </div>
                                                    </div>
                    </div>
                </div>
            ...
            <div class="series-change mt-6 mt-lg-7">
                            ...
                            <div class="series-change__name mb-4 mb-lg-6">
                                <h2 class="series-change__title">Бестселлер</h2>
                                <div class="series-change__desc mt-2">набор для омоложения и сияния кожи</div>
                            </div>
...
<div class="row gx-4 gy-7 mb-7 mb-lg-9">
    ...
    @endforeach
                            ...
                            <div class="series-change__name mb-4 mb-lg-6">
                                <h2 class="series-change__title">3 ступени</h2>
                                <div class="series-change__desc mt-2">тонер+сыворотка+крем</div>
                            </div>
...
<div class="row gx-4 gy-7 mb-7 mb-lg-9">
    ...
    @endforeach
                            ...
                            <div class="series-change__name mb-4 mb-lg-6">
                                <h2 class="series-change__title">4 ступени</h2>
                                <div class="series-change__desc mt-2">энзимное умывание+тонер+сыворотка+крем</div>
                            </div>
