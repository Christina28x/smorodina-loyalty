@extends('layouts.app')
@section('title', 'ТВЕРДЫЕ ПРОДУКТЫ')
@section('content')
<main class="">
...
(
    ...
    [4] => 2951
        ...
        <div class="catalog-section__head" style="background-image: url(https://smorodinacosmetic.com/upload/resize_cache/uf/26d/y9xxo7s34eduyoguzlo05gsapa9plfi0/1400_0_0/Cataloge-preview-banner_3-kopiya.jpg)">
            ...
            <h1 class="text-lowercase">ТВЕРДЫЕ ПРОДУКТЫ</h1>
        </div>
    </div>
...
<div class="row gx-4 gy-7 mb-7 mb-lg-9">
            ...
            <div class="nm_8 col-6 col-md-4 col-lg-3">
                <article class="product-card ssss_8 item " data-id="1119">
                    ...
                    <div class="mt-8">
                <div class="catalog-section__bottom-text"><p style="text-align: center;">
	 Твердые продукты – это самый экологичный и удобный формат привычных<br>
	 средств, который позволяет значительно снизить нагрузку на природу.<br>
 <br>
	 И при этом способны полноценно заменить жидкий уход.
</p></div>
            </div>
