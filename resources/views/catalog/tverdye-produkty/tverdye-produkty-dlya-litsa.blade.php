...
(
    ...
    <pre class="d-none"></pre>
        ...
        <div class="catalog-section__head" style="background-image: url(https://smorodinacosmetic.com/upload/resize_cache/uf/26d/y9xxo7s34eduyoguzlo05gsapa9plfi0/1400_0_0/Cataloge-preview-banner_3-kopiya.jpg)">
            ...
            <h1 class="text-lowercase">Для лица</h1>
        </div>
    </div>
                    ...
                    <div class="swiper-wrapper">
                                    ...
                                    <a href="/catalog/tverdye-produkty/" class="d-block catalog-section__menu__item ">все товары</a>
                                        ...
                                        <a href="/catalog/tverdye-produkty/tverdye-produkty-dlya-volos/" class="d-block catalog-section__menu__item ">Для волос</a>
                                                                    ...
                                                                    <div class="swiper-slide">
                                        <a href="/catalog/tverdye-produkty/tverdye-produkty-dlya-litsa/" class="d-block catalog-section__menu__item catalog-section__menu__item_active">Для лица</a>
                                    </div>
                                                                    <div class="swiper-slide">
