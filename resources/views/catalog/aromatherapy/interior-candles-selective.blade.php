@extends('layouts.app')
@section('title', 'Интерьерные свечи Selective')
@section('content')
<main class="">
...
(
    ...
    <pre class="d-none"></pre>
        ...
        <div class="catalog-section__head" style="background-image: url(https://smorodinacosmetic.com/upload/resize_cache/uf/fac/tkq7tc7a4m13isk6ogmrs9nfp5l9034j/1400_0_0/Cataloge-preview-banner_4-kopiya.jpg)">
            ...
            <h1 class="text-lowercase">Интерьерные свечи Selective</h1>
        </div>
    </div>
                ...
                <div class="catalog-section__menu__slides overflow-visible swiper">
                    <div class="swiper-wrapper">
                                    ...
                                    <a href="/catalog/aromatherapy/" class="d-block catalog-section__menu__item ">все товары</a>
                                                                    ...
                                                                    <div class="swiper-slide">
                                        <a href="/catalog/aromatherapy/aroma-therapy-massage-candles/" class="d-block catalog-section__menu__item ">Массажные свечи Aromatherapy</a>
                                    </div>
                                                                    <div class="swiper-slide">
                                        <a href="/catalog/aromatherapy/interior-candles-selective/" class="d-block catalog-section__menu__item catalog-section__menu__item_active">Интерьерные свечи Selective</a>
                                    </div>
                                                                                                        </div>
