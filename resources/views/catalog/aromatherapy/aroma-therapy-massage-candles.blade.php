@extends('layouts.app')
@section('title', 'Массажные свечи Aromatherapy')
@section('content')
<main class="">
...
(
    ...
    [2] => 125
        ...
        <div class="catalog-section__head" style="background-image: url(https://smorodinacosmetic.com/upload/resize_cache/uf/fac/tkq7tc7a4m13isk6ogmrs9nfp5l9034j/1400_0_0/Cataloge-preview-banner_4-kopiya.jpg)">
            ...
            <h1 class="text-lowercase">Массажные свечи Aromatherapy</h1>
        </div>
    </div>
        ...
        <div class="catalog-section__buttons d-flex mt-4">
                ...
                <div class="catalog-section__menu__slides overflow-visible swiper">
                    <div class="swiper-wrapper">
                                    ...
                                    <a href="/catalog/aromatherapy/" class="d-block catalog-section__menu__item ">все товары</a>
                                </div>
                                                                    <div class="swiper-slide">
                                        <a href="/catalog/aromatherapy/aroma-therapy-massage-candles/" class="d-block catalog-section__menu__item catalog-section__menu__item_active">Массажные свечи Aromatherapy</a>
                                    </div>
                                                                    <div class="swiper-slide">
                                        <a href="/catalog/aromatherapy/interior-candles-selective/" class="d-block catalog-section__menu__item ">Интерьерные свечи Selective</a>
                                    </div>
                                                                                                        </div>
