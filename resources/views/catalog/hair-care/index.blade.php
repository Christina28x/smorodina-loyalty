...
<section class="catalog-section">
        <div class="catalog-section__head" style="background-image: url('{{ asset('img/Cataloge-preview-banner_2.jpg') }}')">
            ...
            <h1 class="text-lowercase">ВОЛОСЫ</h1>
        </div>
    </div>
        ...
        <div class="catalog-section__buttons d-flex mt-4">
                ...
                <div class="catalog-section__menu__slides overflow-visible swiper">
                    <div class="swiper-wrapper">
                                    ...
                                    <a href="/catalog/hair-care/" class="d-block catalog-section__menu__item catalog-section__menu__item_active">все товары</a>
                                </div>
                                                                    <div class="swiper-slide">
