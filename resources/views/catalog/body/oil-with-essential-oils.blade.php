...
(
    ...
    [5] => 59
        ...
        <div class="catalog-section__head" style="background-image: url(https://smorodinacosmetic.com/upload/resize_cache/uf/4ad/tzpri6vdigaxvev26aeok3v23tmo8lw3/1400_0_0/Cataloge-preview-banner.jpg)">
            ...
            <h1 class="text-lowercase">Масла для тела</h1>
        </div>
    </div>
                    ...
                    <div class="swiper-wrapper">
                                    ...
                                    <a href="/catalog/body/" class="d-block catalog-section__menu__item ">все товары</a>
                                        ...
                                        <a href="/catalog/body/brush/" class="d-block catalog-section__menu__item ">Щётки для сухого массажа</a>
                                                                    ...
                                                                    <div class="swiper-slide">
                                        <a href="/catalog/body/oil-with-essential-oils/" class="d-block catalog-section__menu__item catalog-section__menu__item_active">Масла для тела</a>
                                    </div>
                                                                    <div class="swiper-slide">
