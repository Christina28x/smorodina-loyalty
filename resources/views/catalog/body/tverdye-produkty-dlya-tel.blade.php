@extends('layouts.app')
@section('title', 'Твердые продукты для тела')
@section('content')
<main class="">
...
(
    ...
    [1] => 2951
        ...
        <div class="catalog-section__head" style="background-image: url(https://smorodinacosmetic.com/upload/resize_cache/uf/4ad/tzpri6vdigaxvev26aeok3v23tmo8lw3/1400_0_0/Cataloge-preview-banner.jpg)">
            ...
            <h1 class="text-lowercase">Твердые продукты для тела</h1>
        </div>
    </div>
                    ...
                    <div class="swiper-wrapper">
                                    ...
                                    <a href="/catalog/body/" class="d-block catalog-section__menu__item ">все товары</a>
                                        ...
                                        <a href="/catalog/body/krem-dlya-tela-i-ruk/" class="d-block catalog-section__menu__item ">Крем для тела и рук</a>
                                                                    ...
                                                                    <div class="swiper-slide">
                                        <a href="/catalog/body/tverdye-produkty-dlya-tel/" class="d-block catalog-section__menu__item catalog-section__menu__item_active">Твердые продукты для тела</a>
                                    </div>
                                                                    <div class="swiper-slide">
...
<div class="row gx-4 gy-7 mb-7 mb-lg-9">
            ...
            <div class="nm_0 col-6 col-md-4 col-lg-3">
                <article class="product-card ssss_0 item " data-id="1074">
            ...
            <div class="nm_1 col-6 col-md-4 col-lg-3">
                <article class="product-card ssss_1 item " data-id="2430">
                    <div class="product-card__desc">
