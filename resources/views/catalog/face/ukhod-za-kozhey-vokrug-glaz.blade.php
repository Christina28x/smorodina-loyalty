...
(
    ...
    <pre class="d-none"></pre>
        ...
        <div class="catalog-section__head" style="background-image: url(https://smorodinacosmetic.com/upload/resize_cache/uf/619/xog7jqyrkt604r14udjom5uis1psculr/1400_0_0/face.png)">
            ...
            <h1 class="text-lowercase">Кремы для кожи вокруг глаз</h1>
        </div>
    </div>
                    ...
                    <div class="swiper-wrapper">
                                    ...
                                    <a href="/catalog/face/" class="d-block catalog-section__menu__item ">все товары</a>
                                        ...
                                        <a href="/catalog/face/cream/" class="d-block catalog-section__menu__item ">Кремы для лица</a>
                                                                    ...
                                                                    <div class="swiper-slide">
                                        <a href="/catalog/face/ukhod-za-kozhey-vokrug-glaz/" class="d-block catalog-section__menu__item catalog-section__menu__item_active">Кремы для кожи вокруг глаз</a>
                                    </div>
                                                                    <div class="swiper-slide">
