@extends('layouts.app')
@section('title', 'Купить патчи для лица от бренда SmoRodina')
@section('content')
<main class="">
...
(
    [0] => 42
        ...
        <div class="catalog-section__head" style="background-image: url(https://smorodinacosmetic.com/upload/resize_cache/uf/619/xog7jqyrkt604r14udjom5uis1psculr/1400_0_0/face.png)">
            ...
            <h1 class="text-lowercase">Патчи</h1>
        </div>
    </div>
                    ...
                    <div class="swiper-wrapper">
                                    ...
                                    <a href="/catalog/face/" class="d-block catalog-section__menu__item ">все товары</a>
                                        ...
                                        <a href="/catalog/face/alginate-masks/" class="d-block catalog-section__menu__item ">Маски</a>
                                                                    ...
                                                                    <div class="swiper-slide">
                                        <a href="/catalog/face/patchi/" class="d-block catalog-section__menu__item catalog-section__menu__item_active">Патчи</a>
                                    </div>
                                                                    <div class="swiper-slide">
...
<div class="row gx-4 gy-7 mb-7 mb-lg-9">
    ...
    @endforeach
                    ...
                    <div class="mt-8">
                <div class="catalog-section__bottom-text">первые многоразовые патчи, полностью соответствующие принципам Zero Waste</div>
            </div>
