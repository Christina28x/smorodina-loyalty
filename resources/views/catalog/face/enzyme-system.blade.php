@extends('layouts.app')
@section('title', 'Купить энзимную систему от бренда SmoRodina')
@section('content')
<main class="">
...
(
    ...
    <pre class="d-none"></pre>
        ...
        <div class="catalog-section__head" style="background-image: url(https://smorodinacosmetic.com/upload/resize_cache/uf/619/xog7jqyrkt604r14udjom5uis1psculr/1400_0_0/face.png)">
            ...
            <h1 class="text-lowercase">Очищение</h1>
        </div>
    </div>
                ...
                <div class="catalog-section__menu__slides overflow-visible swiper">
                    <div class="swiper-wrapper">
                                    ...
                                    <a href="/catalog/face" class="d-block catalog-section__menu__item ">все товары</a>
                                                                    ...
                                                                    <div class="swiper-slide">
                                        <a href="/catalog/face/enzyme-system" class="d-block catalog-section__menu__item catalog-section__menu__item_active">Очищение</a>
                                    </div>
                                                                    <div class="swiper-slide">
