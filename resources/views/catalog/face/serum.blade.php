@extends('layouts.app')
@section('title', 'Купить сыворотки для лица от бренда SmoRodina')
@section('content')
<main class="">
...
<section class="catalog-section">
        <div class="catalog-section__head" style="background-image: url('{{ asset('img/face.png') }}')">
            ...
            <h1 class="text-lowercase">Сыворотки</h1>
        </div>
    </div>
                    ...
                    <div class="swiper-wrapper">
                                    ...
                                    <a href="/catalog/face/" class="d-block catalog-section__menu__item ">все товары</a>
                                        ...
                                        <a href="/catalog/face/hydrolate/" class="d-block catalog-section__menu__item ">Гидролаты</a>
                                                                    ...
                                                                    <div class="swiper-slide">
                                        <a href="/catalog/face/serum/" class="d-block catalog-section__menu__item catalog-section__menu__item_active">Сыворотки</a>
                                    </div>
                                                                    <div class="swiper-slide">
