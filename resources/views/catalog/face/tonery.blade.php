@extends('layouts.app')
@section('title', 'Тонеры для лица SmoRodina — купить в интернет-магазине SmoRodina')
@section('content')
<main class="">
...
(
    ...
    <pre class="d-none"></pre>
        ...
        <div class="catalog-section__head" style="background-image: url(https://smorodinacosmetic.com/upload/resize_cache/uf/619/xog7jqyrkt604r14udjom5uis1psculr/1400_0_0/face.png)">
            ...
            <h1 class="text-lowercase">Тонеры</h1>
        </div>
    </div>
                    ...
                    <div class="swiper-wrapper">
                                    ...
                                    <a href="/catalog/face/" class="d-block catalog-section__menu__item ">все товары</a>
                                        ...
                                        <a href="/catalog/face/enzyme-system/" class="d-block catalog-section__menu__item ">Очищение</a>
                                                                    ...
                                                                    <div class="swiper-slide">
                                        <a href="/catalog/face/tonery/" class="d-block catalog-section__menu__item catalog-section__menu__item_active">Тонеры</a>
                                    </div>
                                                                    <div class="swiper-slide">
...
<div class="row gx-4 gy-7 mb-7 mb-lg-9">
    ...
    @endforeach
                    ...
                    <div class="mt-8">
                <div class="catalog-section__bottom-text">восстанавливает pH кожи после умывания, увлажняет и работает как проводник для активных компонентов ухода</div>
            </div>
